...
当前版本 **0.4.1**。新增两把不可损坏的成长剑、灵魂吞噬、随机强化怪物和独立剑灵对话框。提供 **Fabric / Minecraft 1.20.1 / Java 17** 与 **NeoForge / Minecraft 1.21.1 / Java 21** 两个版本。客户端和服务器均需安装对应版本。
...
每次有效击杀使剑实际提升成长等级，持有者都会恢复到当时的生命上限。普通击杀、收放剑、刷新属性和合成进阶本身不触发回血；基础剑封顶后仍记录击杀，但不再触发升级回血。此回血不补充伤害吸收的黄心。
